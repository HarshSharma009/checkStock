...
if __name__ == "__main__":
    ...
    parser.add_argument('base_ccy', metavar='base_ccy', type=str, help='base currency (for e.g. INR in INR/USD)')
    parser.add_argument('ccy', metavar='ccy', type=str, help='instrument currency (for e.g. USD in INR/USD)')
